...
class HomeController extends Controller
{
    ...
    $previousResults = Result::where('match_date', '<', now())
        ...
        return view('pages.frontend.home.new-index', compact('articles', 'testimonials', 'upcomings', 'latestVideos', 'sublatestVideos', 'galleries', 'sponsorships', 'klasemens', 'lastMatch', 'previousResults'));
    }
